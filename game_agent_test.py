...
def min_value(self,gameState,depth):
    ...
    for m in gameState.get_legal_moves():
        v = min(v, self.max_value(gameState.forecast_move(m),depth))
    return v
...
def max_value(self,gameState,depth):
    ...
    v = float("-inf")
    for m in gameState.get_legal_moves():
        v = max(v, self.min_value(gameState.forecast_move(m),depth))
    return v
...
def minimax_decision(self,gameState,depth):
    ...
    return max(gameState.get_legal_moves(), key=lambda m: self.min_value(gameState.forecast_move(m),depth)) #max(iterable[, key])
